...
public class WeightedTree<T> {
	...
	public WeightedList<T> flatten() {
		return null; //TODO: gonna need some robust GCD for this and overflow handling PAIN
	}
	...
	public Optional<T> getRandom(DoubleUnaryOperator random) {
		...
		return value instanceof WeightedTree ? ((WeightedTree<T>)value).getRandom(random) : (Optional<T>)opt;
	}
